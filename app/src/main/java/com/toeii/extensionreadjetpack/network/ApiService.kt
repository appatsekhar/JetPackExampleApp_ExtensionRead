...
interface ApiService {
    ...
    suspend fun getHomeRecommendList(@Path("number") number: String,@Path("page") page: String): XianDuViceEntity

    // 首页日报
    @GET("/api/xiandu/data/id/qdaily/count/{number}/page/{page}")
    suspend fun getHomeDailyList(@Path("number") number: String,@Path("page") page: String): XianDuQdailyEntity
